using P4G_EXE_PTBR.Configuration;
using P4G_EXE_PTBR.Configuration.Implementation;
...
namespace P4G_EXE_PTBR
{
    public class Program : IMod
    {
        ...
        /// </summary>
        private const string MyModId = "P4G_EXE_PTBR";
        ...
        public void Start(IModLoaderV1 loader)
        {
            ...
            _logger.WriteLine("[P4G PC EXE PT-BR] Hello World!");

            Patcher patcher = new Patcher(_logger);
            patcher.Patch();
        }
